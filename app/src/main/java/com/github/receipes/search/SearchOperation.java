...
public enum SearchOperation {
    ...
    public static SearchOperation getDataOption(final String dataOption) {
        return switch (dataOption) {
            case "all" -> ALL;
            case "any" -> ANY;
            default -> throw new IllegalArgumentException("Could not find SearchOperation for dataOption :" + dataOption);
        };
    }
    ...
    public static SearchOperation getSimpleOperation(final String input) {
        return switch (input) {
            ...
            default -> throw new IllegalArgumentException("Could not find SearchOperation for dataOption :" + input);
        };
    }
}
